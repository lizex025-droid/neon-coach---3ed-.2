...
export const STACK_WINDOWS = [
  ...
  { key: 'lunch', icon: '', title: 'Lunch', titleAr: 'الغداء', time: '12–2 PM' },
  { key: 'evening', icon: '', title: 'Evening', titleAr: 'المساء', time: '9–11 PM' },
  { key: 'anytime', icon: '', title: 'Anytime', titleAr: 'أي وقت', time: 'No fixed window' }
];

export const SUPPLEMENT_DB = [
  { name: 'Creatine monohydrate', nameAr: 'كرياتين مونوهيدرات', displayName: 'Creatine monohydrate / كرياتين مونوهيدرات', dose: '5g', window: 'anytime', note: 'يومياً — الاستمرارية أهم من التوقيت', icon: '', aliases: ['creatine', 'كرياتين'] },
  { name: 'Beta-alanine', nameAr: 'بيتا ألانين', displayName: 'Beta-alanine / بيتا ألانين', dose: '2–5g', window: 'morning', note: 'قبل التمرين — تجزئة الجرعات لتجنب الوخز', icon: '', aliases: ['beta alanine', 'بيتا ألانين'] },
  { name: 'L-citrulline', nameAr: 'إل-سيترولين', displayName: 'L-citrulline / إل-سيترولين', dose: '6–8g', window: 'morning', note: 'قبل التمرين بـ 30 دقيقة لضخ الدم (Pump)', icon: '', aliases: ['citrulline', 'سيترولين'] },
  { name: 'BCAAs', nameAr: 'أحماض أمينية BCAA', displayName: 'BCAAs / أحماض أمينية BCAA', dose: '5–10g', window: 'anytime', note: 'أثناء أو بعد التمرين للاستشفاء', icon: '', aliases: ['bcaa', 'بي سي اي اي'] },
  ...
  { name: 'L-carnitine', nameAr: 'إل-كارنتين', displayName: 'L-carnitine / إل-كارنتين', dose: '1–2g', window: 'morning', note: 'مع وجبة كارب لامتصاص مثالي', icon: '', aliases: ['carnitine', 'كارنتين'] },
  ...
  { name: 'HMB', nameAr: 'إتش إم بي (HMB)', displayName: 'HMB / إتش إم بي', dose: '3g', window: 'anytime', note: 'مقسمة على 3 مرات لحماية الكتلة العضلية', icon: '', aliases: ['hmb'] },
  { name: 'Glutamine', nameAr: 'جلوتامين', displayName: 'Glutamine / جلوتامين', dose: '5g', window: 'anytime', note: 'دعم الاستشفاء وصحة الأمعاء', icon: '', aliases: ['l-glutamine', 'جلوتامين'] },
  { name: 'Vitamin D3', nameAr: 'فيتامين د3', displayName: 'Vitamin D3 / فيتامين د3', dose: '2000–5000 IU', window: 'lunch', note: 'يذوب في الدهون — يؤخذ مع أكبر وجبة', icon: '', aliases: ['vit d', 'vitamin d', 'd3', 'cholecalciferol', 'فيتامين د'] },
