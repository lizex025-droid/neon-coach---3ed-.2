  ...
  return `
    <div class="weekly-checkin-container" style="padding: 16px 16px 110px; display: flex; flex-direction: column; gap: 16px;">
      ...
      <div style="display: flex; align-items: center; justify-content: space-between;">
        ...
        <span class="badge badge-neon" style="font-size: 0.72rem; padding: 4px 10px; display: inline-flex; align-items: center; gap: 4px;">
          ${neonIcon('shield', 13)} خصوصيتك محمية
        </span>
      </div>
      ...
      <div style="text-align: center; margin-bottom: 4px;">
        ...
        <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
          ...
          <div style="width: 22px; height: 22px; border-radius: 50%; border: 2px solid #55F7A5; display: flex; align-items: center; justify-content: center;">
            ${neonIcon('check', 12)}
          </div>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 10px;">
        ...
        <!-- الجوع -->
        <div class="neon-card" style="padding: 14px 8px; text-align: center;">
          <div style="font-size: 0.78rem; color: #B8C0BC; margin-bottom: 4px; display: flex; align-items: center; justify-content: center; gap: 4px;">${neonIcon('plate', 14)} الجوع</div>
          <div style="color: #55F7A5; font-size: 0.9rem; margin-bottom: 2px;">★★☆☆☆</div>
          <div style="font-weight: 800; font-size: 0.85rem; color: #FFFFFF; font-family: monospace;">2 / 5</div>
        </div>
        ...
        <!-- الطاقة -->
        <div class="neon-card" style="padding: 14px 8px; text-align: center;">
          <div style="font-size: 0.78rem; color: #B8C0BC; margin-bottom: 4px; display: flex; align-items: center; justify-content: center; gap: 4px;">${neonIcon('flame', 14)} الطاقة</div>
          <div style="color: #55F7A5; font-size: 0.9rem; margin-bottom: 2px;">★★★★☆</div>
        ...
        <!-- الماء -->
        <div class="neon-card" style="padding: 14px 8px; text-align: center;">
          <div style="font-size: 0.78rem; color: #B8C0BC; margin-bottom: 4px; display: flex; align-items: center; justify-content: center; gap: 4px;">${neonIcon('water', 14)} الماء</div>
        ...
        <!-- التمارين -->
        <div class="neon-card" style="padding: 14px 8px; text-align: center;">
          <div style="font-size: 0.78rem; color: #B8C0BC; margin-bottom: 4px; display: flex; align-items: center; justify-content: center; gap: 4px;">${neonIcon('dumbbell', 14)} التمارين</div>
          <div style="font-weight: 900; font-size: 1.4rem; color: #FFFFFF; font-family: monospace;">
      ...
      <div class="neon-card" style="padding: 18px;">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px;">
          ...
          <span style="display: flex; align-items: center;">${neonIcon('user', 18)}</span>
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
          <button id="pain-no-btn" class="btn ${checkin.hasPain ? 'btn-secondary' : 'btn-primary'}" style="border-radius: 14px; padding: 10px; display: flex; align-items: center; justify-content: center; gap: 6px;">
            <span>لا</span>
            ${neonIcon('check', 14)}
          </button>
      ...
      <div class="neon-card" style="padding: 20px;">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 4px;">
          ...
          <span>${neonIcon('camera', 20)}</span>
        </div>
        <p style="font-size: 0.8rem; color: #B8C0BC; margin-bottom: 16px; display: flex; align-items: center; gap: 4px;">
          ${neonIcon('shield', 14)} صورك خاصة ومحفوظة بأمان محلياً على جهازك.
        </p>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">
          ...
          <label class="neon-card" style="padding: 16px 8px; text-align: center; border-style: dashed; cursor: pointer; background: #050d09;">
            ...
            <div style="margin-bottom: 4px; display: flex; justify-content: center;">${neonIcon('camera', 28)}</div>
      ...
      <!-- زر حفظ المتابعة -->
      <button id="submit-checkin-btn" class="btn btn-primary btn-lg btn-block" style="border-radius: 20px; font-size: 1.15rem; font-weight: 800; display: flex; align-items: center; justify-content: center; gap: 8px;">
